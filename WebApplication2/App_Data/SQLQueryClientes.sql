...
GO
ALTER TABLE [dbo].[Clientes] ALTER COLUMN [Endereco] NVARCHAR (255) NOT NULL;

ALTER TABLE [dbo].[Clientes] ALTER COLUMN [Nome] NVARCHAR (255) NOT NULL;
...
GO
PRINT N'Criando Tabela [dbo].[Tatuagens]...';
...
GO
PRINT N'Criando Chave Estrangeira restrição sem nome em [dbo].[Tatuagens]...';


GO
ALTER TABLE [dbo].[Tatuagens] WITH NOCHECK
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Tatuagens'))
               AND [type] IN (N'F', N'C')
