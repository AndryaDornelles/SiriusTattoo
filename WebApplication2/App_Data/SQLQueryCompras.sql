...
BEGIN TRANSACTION
GO
PRINT N'Criando Tabela [dbo].[Compras]...';
...
GO
PRINT N'Criando Chave Estrangeira restrição sem nome em [dbo].[Compras]...';


GO
ALTER TABLE [dbo].[Compras] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[Compras] WITH NOCHECK
    ADD FOREIGN KEY ([Tatuagem_Id]) REFERENCES [dbo].[Tatuagens] ([Id]);
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Compras'))
               AND [type] IN (N'F', N'C')
